...
namespace App.Models.RobotPartes
{
    class RHead : Parte
    {
        ...
        public override TexturedVertex[] GetVerts2()
        {
            ...
            {
                //Frente
                new TexturedVertex(new Vector4(centro.X - (cx * 0.5f), centro.Y +  cy,         centro.Z + (cz * 0.4f), 1), new Vector2(0,h)),
                ...
                new TexturedVertex(new Vector4(centro.X + (cx * 0.5f), centro.Y + (cy * 0.5f), centro.Z + (cz * 0.4f), 1), new Vector2(0,0)),
                new TexturedVertex(new Vector4(centro.X - (cx * 0.5f), centro.Y +  cy,         centro.Z + (cz * 0.4f), 1), new Vector2(w,h)),
                new TexturedVertex(new Vector4(centro.X + (cx * 0.5f), centro.Y +  cy,         centro.Z + (cz * 0.4f), 1), new Vector2(w,0)),
                ...
                new TexturedVertex(new Vector4(centro.X + (cx * 0.5f), centro.Y + (cy * 0.5f), centro.Z - (cz * 0.4f), 1), new Vector2(w,h)),
                new TexturedVertex(new Vector4(centro.X + (cx * 0.5f), centro.Y + (cy * 0.5f), centro.Z - (cz * 0.4f), 1), new Vector2(w,h)),
                new TexturedVertex(new Vector4(centro.X - (cx * 0.5f), centro.Y + cy,          centro.Z - (cz * 0.4f), 1), new Vector2(0,0)),
                new TexturedVertex(new Vector4(centro.X + (cx * 0.5f), centro.Y + cy,          centro.Z - (cz * 0.4f), 1), new Vector2(0,h)),
                ...
                //Frente 
                new TexturedVertex(new Vector4(centro.X - (cx * 0.1f), centro.Y + (cy * 0.5f), centro.Z + (cz * 0.1f), 1), new Vector2(0,h)),
                new TexturedVertex(new Vector4(centro.X - (cx * 0.1f), centro.Y + (cy * 0.4f), centro.Z + (cz * 0.1f), 1), new Vector2(w,h)),
                new TexturedVertex(new Vector4(centro.X + (cx * 0.1f), centro.Y + (cy * 0.4f), centro.Z + (cz * 0.1f), 1), new Vector2(0,0)),
                new TexturedVertex(new Vector4(centro.X + (cx * 0.1f), centro.Y + (cy * 0.4f), centro.Z + (cz * 0.1f), 1), new Vector2(0,0)),
                new TexturedVertex(new Vector4(centro.X - (cx * 0.1f), centro.Y + (cy * 0.5f), centro.Z + (cz * 0.1f), 1), new Vector2(w,h)),
                new TexturedVertex(new Vector4(centro.X + (cx * 0.1f), centro.Y + (cy * 0.5f), centro.Z + (cz * 0.1f), 1), new Vector2(w,0)),
                ...
                new TexturedVertex(new Vector4(centro.X + (cx * 0.1f), centro.Y + (cy * 0.4f), centro.Z - (cz * 0.1f), 1), new Vector2(w,h)),
                new TexturedVertex(new Vector4(centro.X + (cx * 0.1f), centro.Y + (cy * 0.4f), centro.Z - (cz * 0.1f), 1), new Vector2(w,h)),
                new TexturedVertex(new Vector4(centro.X - (cx * 0.1f), centro.Y + (cy * 0.5f), centro.Z - (cz * 0.1f), 1), new Vector2(0,0)),
                new TexturedVertex(new Vector4(centro.X + (cx * 0.1f), centro.Y + (cy * 0.5f), centro.Z - (cz * 0.1f), 1), new Vector2(0,h)),
                ...
                new TexturedVertex(new Vector4(centro.X - (cx * 0.1f), centro.Y + (cy * 0.5f), centro.Z - (cz * 0.1f), 1), new Vector2(w,h)),
                new TexturedVertex(new Vector4(centro.X - (cx * 0.1f), centro.Y + (cy * 0.4f), centro.Z + (cz * 0.1f), 1), new Vector2(0,0)),
                new TexturedVertex(new Vector4(centro.X - (cx * 0.1f), centro.Y + (cy * 0.4f), centro.Z - (cz * 0.1f), 1), new Vector2(0,h)),
                ...
                new TexturedVertex(new Vector4(centro.X - (cx * 0.1f), centro.Y + (cy * 0.4f), centro.Z - (cz * 0.1f), 1), new Vector2(0,0)),
                new TexturedVertex(new Vector4(centro.X + (cx * 0.1f), centro.Y + (cy * 0.4f), centro.Z + (cz * 0.1f), 1), new Vector2(w,h)),
                new TexturedVertex(new Vector4(centro.X + (cx * 0.1f), centro.Y + (cy * 0.4f), centro.Z - (cz * 0.1f), 1), new Vector2(w,0)),
            };
        }
