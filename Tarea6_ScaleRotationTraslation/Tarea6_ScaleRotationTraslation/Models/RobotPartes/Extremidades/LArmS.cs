...
namespace Tarea6_ScaleRotationTraslation.Models.RobotPartes.Extremidades
{
    ...
    class LArmS : Parte
    {
        public LArmS(Vector3 centro, float anchoX, float altoY, float profZ)
        {
            this.centro = centro;
            this.cx = anchoX / 2;
            this.cy = altoY / 2;
        ...
        public override Vertex[] GetVerts()
        {
            ...
            {
            //Frente
            new Vertex(new Vector4(centro.X - (cx * 0.7f), centro.Y + (cy * 0.4f), centro.Z + (cz * 0.2f), 1), color),
            ...
            new Vertex(new Vector4(centro.X - (cx * 0.5f), centro.Y + (cy * 0.1f), centro.Z + (cz * 0.2f), 1), color),
            new Vertex(new Vector4(centro.X - (cx * 0.7f), centro.Y + (cy * 0.4f), centro.Z + (cz * 0.2f), 1), color),
            new Vertex(new Vector4(centro.X - (cx * 0.5f), centro.Y + (cy * 0.4f), centro.Z + (cz * 0.2f), 1), color),
        ...
        public override TexturedVertex[] GetVerts2()
        {
            ...
            {
            //Frente
            new TexturedVertex(new Vector4(centro.X - (cx * 0.7f), centro.Y + (cy * 0.4f), centro.Z + (cz * 0.2f), 1), new Vector2(0,h)),
            ...
            new TexturedVertex(new Vector4(centro.X - (cx * 0.5f), centro.Y + (cy * 0.1f), centro.Z + (cz * 0.2f), 1), new Vector2(0,0)),
            new TexturedVertex(new Vector4(centro.X - (cx * 0.7f), centro.Y + (cy * 0.4f), centro.Z + (cz * 0.2f), 1), new Vector2(w,h)),
            new TexturedVertex(new Vector4(centro.X - (cx * 0.5f), centro.Y + (cy * 0.4f), centro.Z + (cz * 0.2f), 1), new Vector2(w,0)),

            //Abajo
            new TexturedVertex(new Vector4(centro.X - (cx * 0.7f), centro.Y + (cy * 0.4f), centro.Z - (cz * 0.2f), 1), new Vector2(w,0)),
            ...
            new TexturedVertex(new Vector4(centro.X - (cx * 0.5f), centro.Y + (cy * 0.1f), centro.Z - (cz * 0.2f), 1), new Vector2(w,h)),
            new TexturedVertex(new Vector4(centro.X - (cx * 0.7f), centro.Y + (cy * 0.4f), centro.Z - (cz * 0.2f), 1), new Vector2(0,0)),
            new TexturedVertex(new Vector4(centro.X - (cx * 0.5f), centro.Y + (cy * 0.4f), centro.Z - (cz * 0.2f), 1), new Vector2(0,h)),
            ...
            new TexturedVertex(new Vector4(centro.X - (cx * 0.5f), centro.Y + (cy * 0.1f), centro.Z - (cz * 0.2f), 1), new Vector2(w,h)),
            new TexturedVertex(new Vector4(centro.X - (cx * 0.5f), centro.Y + (cy * 0.1f), centro.Z - (cz * 0.2f), 1), new Vector2(w,h)),
            new TexturedVertex(new Vector4(centro.X - (cx * 0.5f), centro.Y + (cy * 0.4f), centro.Z + (cz * 0.2f), 1), new Vector2(0,0)),
            new TexturedVertex(new Vector4(centro.X - (cx * 0.5f), centro.Y + (cy * 0.4f), centro.Z - (cz * 0.2f), 1), new Vector2(0,h)),

                //Arriba
            new TexturedVertex(new Vector4(centro.X - (cx * 0.7f), centro.Y + (cy * 0.4f), centro.Z + (cz * 0.2f), 1), new Vector2(0,h)),
            new TexturedVertex(new Vector4(centro.X - (cx * 0.5f), centro.Y + (cy * 0.4f), centro.Z + (cz * 0.2f), 1), new Vector2(w,h)),
            new TexturedVertex(new Vector4(centro.X - (cx * 0.7f), centro.Y + (cy * 0.4f), centro.Z - (cz * 0.2f), 1), new Vector2(0,0)),
            new TexturedVertex(new Vector4(centro.X - (cx * 0.7f), centro.Y + (cy * 0.4f), centro.Z - (cz * 0.2f), 1), new Vector2(0,0)),
            new TexturedVertex(new Vector4(centro.X - (cx * 0.5f), centro.Y + (cy * 0.4f), centro.Z + (cz * 0.2f), 1), new Vector2(w,h)),
            new TexturedVertex(new Vector4(centro.X - (cx * 0.5f), centro.Y + (cy * 0.4f), centro.Z - (cz * 0.2f), 1), new Vector2(w,0)),
