...
namespace Tarea6_ScaleRotationTraslation.Models.RobotPartes
{
    class LeftArm : Parte
    {
        ...
        public LeftArm(Vector3 centro, float anchoX, float altoY, float profZ)
        {
            this.centro = centro;
            ...
            extremos.Add("lsuperior", as1);
            extremos.Add("linferior", as2);
        ...
        public override TexturedVertex[] GetVerts2()
        {
            ...
            TexturedVertex[] x = extremos.Get("lsuperior").GetVerts2();
            TexturedVertex[] y = extremos.Get("linferior").GetVerts2();
