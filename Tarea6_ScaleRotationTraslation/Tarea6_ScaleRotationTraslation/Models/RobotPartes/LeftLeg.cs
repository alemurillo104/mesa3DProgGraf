...
namespace Tarea6_ScaleRotationTraslation.Models.RobotPartes
{
    class LeftLeg : Parte
    {
        ...
        public LeftLeg(Vector3 centro, float anchoX, float altoY, float profZ)
        {
            this.centro = centro;
            ...
            extremos.Add("lgsuperior", as1);
            extremos.Add("lginferior", as2);
        ...
        public override TexturedVertex[] GetVerts2()
        {
            ...
            TexturedVertex[] x = extremos.Get("lgsuperior").GetVerts2();
            TexturedVertex[] y = extremos.Get("lginferior").GetVerts2();
